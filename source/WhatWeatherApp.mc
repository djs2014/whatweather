...
class WhatWeatherApp extends Application.AppBase {
    ...
    function loadUserSettings() {
        try {			
        	$._showCurrentForecast = getBooleanProperty("showCurrentForecast", true);
            $._maxMinuteForecast = getNumberProperty("maxMinuteForecast", 60);
            $._maxHoursForecast = getNumberProperty("maxHoursForecast", 8);
            $._alertLevelPrecipitationChance = getNumberProperty("alertLevelPrecipitationChance", 70);
            $._showAlertLevel = getBooleanProperty("showAlertLevel", true);
            $._showMaxPrecipitationChance = getBooleanProperty("showMaxPrecipitationChance", true);
            $._dashesUnderColumnHeight = getNumberProperty("dashesUnderColumnHeight", 2);
            $._showColumnBorder = getBooleanProperty("showColumnBorder", false);
            $._showObservationTime = getBooleanProperty("showObservationTime", true);
            $._showObservationLocationName = getBooleanProperty("showObservationLocationName", true);
            $._observationTimeDelayedMinutesThreshold = getNumberProperty("observationTimeDelayedMinutesThreshold", 30);
            ...
            $._showPrecipitationChanceAxis = getBooleanProperty("showPrecipitationChanceAxis", true);		
            $._alertLevelUVi = getNumberProperty("alertLevelUVi", 6);
            $._alertLevelRainMMfirstHour = getNumberProperty("alertLevelRainMMfirstHour", 5);
